...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(e,t){t.otherwise("/employee"),e.state("employee",{url:"/employee",templateUrl:"templates/employee.html"}).state("role",{url:"/role",templateUrl:"templates/role.html"}).state("course",{url:"/course",templateUrl:"templates/course.html"}).state("sample",{url:"/sample",templateUrl:"templates/sample.html"})}]);
...
function CourseCtrl(e){e.message="welcome"}angular.module("RDash").controller("CourseCtrl",["$scope",CourseCtrl]);
function EmployeeCtrl(e){e.message="welcome"}angular.module("RDash").controller("EmployeeCtrl",["$scope",EmployeeCtrl]);
...
function RoleCtrl(l){l.message="welcome"}angular.module("RDash").controller("RoleCtrl",["$scope",RoleCtrl]);
function SampleCtrl(l){l.message="welcome"}angular.module("RDash").controller("SampleCtrl",["$scope",SampleCtrl]);
